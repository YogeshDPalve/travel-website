import { login, logout } from "@/lib/file-actions";
        ...
        <div className="flex items-center space-x-4">
          {session ? (
            <>
              ...
              <button
                className="flex items-center justify-center cursor-pointer bg-gray-800 hover:bg-gray-900 text-white p-2 rounded-sm shadow-md"
                onClick={logout}
              >
                Sign Out
              </button>
            ...
            <button
              className="flex items-center justify-center cursor-pointer bg-gray-800 hover:bg-gray-900 text-white p-2 rounded-sm shadow-sm"
              onClick={login}
            >
              Sign In
              <svg
